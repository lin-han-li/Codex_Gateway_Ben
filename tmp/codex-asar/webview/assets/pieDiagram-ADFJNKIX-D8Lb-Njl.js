import{i as e,r as t}from"./src-ClLCzxTM.js";import{B as n,C as r,U as i,_ as a,a as o,b as s,c,d as l,v as u,z as d}from"./chunk-ABZYJK2D-DJBL64l8.js";import{t as f}from"./ordinal-C9YcDRnK.js";import{t as p}from"./arc-jCFxyJ-G.js";import{t as m}from"./pie-DPuKVBh7.js";import{f as h,r as g}from"./chunk-S3R3BYOJ-B_CcVm51.js";import{t as _}from"./chunk-EXTU4WIE-BUYVeOhi.js";import"./dist-Cya8pHUx.js";import"./chunk-FPAJGGOC-MlNoy9fu.js";import"./chunk-O7ZBX7Z2-wpHNBiF1.js";import"./chunk-S6J4BHB3-CD933OtO.js";import"./chunk-LBM3YZW2-kCPsh0L4.js";import"./chunk-76Q3JFCE-Dc7Kk4T_.js";import"./chunk-T53DSG4Q-L0_wM_Ev.js";import"./chunk-LHMN2FUI-DnoTBDL3.js";import"./chunk-FWNWRKHM-B4DB5lhT.js";import{t as v}from"./chunk-4BX2VUAB-BlC2KK-B.js";import{t as y}from"./mermaid-parser.core-CM07EesH.js";var b=l.pie,x={sections:new Map,showData:!1,config:b},S=x.sections,C=x.showData,w=structuredClone(b),T={getConfig:t(()=>structuredClone(w),`getConfig`),clear:t(()=>{S=new Map,C=x.showData,o()},`clear`),setDiagramTitle:i,getDiagramTitle:r,setAccTitle:n,getAccTitle:u,setAccDescription:d,getAccDescription:a,addSection:t(({label:t,value:n})=>{if(n<0)throw Error(`"${t}" has invalid value: ${n}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);S.has(t)||(S.set(t,n),e.debug(`added new section: ${t}, with value: ${n}`))},`addSection`),getSections:t(()=>S,`getSections`),setShowData:t(e=>{C=e},`setShowData`),getShowData:t(()=>C,`getShowData`)},E=t((e,t)=>{v(e,t),t.setShowData(e.showData),e.sections.map(t.addSection)},`populateDb`),D={parse:t(async t=>{let n=await y(`pie`,t);e.debug(n),E(n,T)},`parse`)},O=t(e=>`
  .pieCircle{
...
//# sourceMappingURL=pieDiagram-ADFJNKIX-D8Lb-Njl.js.map